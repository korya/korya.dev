...
But this year, I actually asked ClaudeCode to make it a single script and after
a couple of iterations, we got to a working version.
...
- addition of ClaudeCode and Codex
  Note: i've some basic skills as well but later moved them to [korya/swd-skills](https://github.com/korya/swd-skills)
- I've added the [Zed](https://zed.dev/) editor as an experiment
- per-session history in zsh: [bf5a9a7](https://github.com/korya/dotfiles/commit/bf5a9a780f0f9f4ba6ea1f02f0e2be33e7bc75b6)
- [mprocs](https://github.com/pvolok/mprocs) a cool utililty 
...
We install some super basic tools (GNU core utils and others), see [.korya.d/Brewfile](https://github.com/korya/dotfiles/blob/304be58206760e0121ab229f50efe6d9f228bcf5/.korya.d/Brewfile)

New tools:
- [mprocs](https://github.com/sigoden/mprocs) is a super cool tool for running multiple processes in parallel. It is especially useful for complex setup requiring multiple multiple backends, databases, a frontend dev server, etc.
  Combined with [just](https://github.com/casey/just) it is super powerful.
  Not all my projects have `just run` that runs `mprocs` that runs the setup using other `just` commands. 🤯
- [uv](https://github.com/astral-sh/uv) is a modern package manager for Python.
- [vp](https://viteplus.dev/) is a modern build tool for web full stack projects.
- [infisical](https://infisical.com/) is a modern and easy-to-use secrets management tool.
