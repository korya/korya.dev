...
toc: false
takeaways:
  - 'AI agents are a new software layer, with narrow expert agents collaborating on specific tasks.'
  - 'Personal assistants could coordinate real-world services instead of only answering questions.'
  - 'Adoption depends as much on security, law, and institutions as it does on model capability.'
videos:
  - youtubeId: 'm0ZGDnP4C0M'
    title: 'Era of Agents: What Is Coming'
    description: "Why AI agents are a new kind of software rather than hype, and how phones turn into personal assistants that handle real-world tasks."
    uploadDate: '2026-06-25T19:35:36-07:00'
    duration: 'PT3M51S'
    thumbnail:
      src: '/images/posts/2026-05-29-era-of-agents-what-is-coming/m0ZGDnP4C0M.jpg'
      alt: 'Video thumbnail for Era of Agents: What Is Coming'
      width: 1280
      height: 720
---
...
<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; margin: var(--space-lg, 2rem) 0;">
  <iframe
    ...
    src="https://www.youtube-nocookie.com/embed/m0ZGDnP4C0M"
    title="Era of agents: what is coming"
    loading="lazy"
...
Hey, I kept being asked about the agent hype and I wanted to clarify it. Yes, there is a lot of hype around AI agents. But AI agents are not just hype. It's a new form of software, and we have already entered the era of agents.
...
- [Google's Agent2Agent protocol announcement](https://developers.googleblog.com/en/a2a-a-new-era-of-agent-interoperability/) describes agents coordinating work across vendors and applications.
- [The Model Context Protocol overview](https://modelcontextprotocol.io/docs/getting-started/intro) explains how agents connect to external data, tools, and workflows.
